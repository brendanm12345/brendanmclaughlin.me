...
export const research: Record<string, any> = {
    weaver: {
        ...
        description: 'A framework for designing a strong verifier by combining multiple weak, imperfect verifiers. (NeurIPS 2025)',
        image: '',
        links: [
            {
                name: 'Paper',
...
export const projectsV2: Record<string, any> = {
    ...
    appBench: {
        name: 'AppBench: Benchmarking AI-Generated Web Applications',
        description: 'A preliminary benchmark for evaluating AI systems on web application generation tasks',
        image: '',
        links: [
            {
                name: 'Paper',
                url: '/appbench/app-bench-paper.pdf', // You'll need to update this with the actual repository and PDF path
            },
        ],
    },
    onboardingAgents: {
